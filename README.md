...
# ShinyArchrUiO
  ...
  Example of web interface on tutorial dataset is available at [ShinyArchR.UiO](https://cancell.medisin.uio.no/ShinyArchR.UiO) website ([Sharma et al, Bioinformatics,2021](https://academic.oup.com/bioinformatics/advance-article/doi/10.1093/bioinformatics/btab680/6377776)). Learn more from our videotutorials: (https://www.youtube.com/@chromatinbiology3354).
...
***
![ShinyArchRUiO tab Information](https://github.com/EskelandLab/ShinyArchRUiO/blob/main/ArchRAnalysis/tab_info_wiki.png)
***
...
Please watch ShinyArchR.UiO's **[Introduction video tutorial](https://www.youtube.com/watch?v=gIUGgJWlWCw)**.  


Please watch  ShinyArchR.UiO's **[Setup video tutorial](https://www.youtube.com/watch?v=diyySkVfmks)**.  
